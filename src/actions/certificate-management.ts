...
export const uploadCertificateToCloudinary = protectedAction(
	async (
		eventId: number,
		userId: number,
	...
	{
		actionName: "certificate.ALLPERM",
	},
);

export const getCertificatesForEvent = protectedAction(
...
export const sendCertificateEmail = protectedAction(
	async (
		certificateId: string,
	): Promise<{
		success: boolean;
...
export const getEventCertificateStatus = protectedAction(
	async (
		eventId: number,
	): Promise<{
		success: boolean;
...
export const getEventCertificateList = protectedAction(
	async (
		eventId: number,
	): Promise<{
		success: boolean;
...
export const clearAllCertificates = protectedAction(
