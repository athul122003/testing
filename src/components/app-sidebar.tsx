...
import { LayoutDashboard, Calendar, FileText, ImageIcon, CreditCard, Users, Settings } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarHeader,
...
export function AppSidebar({ activePage, setActivePage }: AppSidebarProps) {
  return (
    <Sidebar className="border-r-0" style={{ backgroundColor: "#000000" }}>
      <SidebarHeader className="p-6 border-b border-gray-800" style={{ backgroundColor: "#000000" }}>
