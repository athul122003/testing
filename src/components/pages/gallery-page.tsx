    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">Manage your image collection</p>
        </div>
        ...
        {filteredImages.map((image) => (
          ...
          >
            ...
            <CardContent className="p-4">
              <h3 className="font-bold text-slate-900 dark:text-white mb-2 line-clamp-2">{image.title}</h3>
        ...
        <Card className="border-0 shadow-lg bg-white dark:bg-slate-800">
          <CardContent className="text-center py-12">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg">
              {selectedYear === "all" ? "No images in gallery yet" : `No images found for ${selectedYear}`}
            </p>
            <p className="text-slate-500 dark:text-slate-500">
              {selectedYear === "all" ? "Add your first image to get started!" : "Try selecting a different year."}
            </p>
          </CardContent>
        </Card>
      )}
