  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-600 dark:text-slate-400">Manage your application preferences and configuration</p>
      </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Notifications for new user registrations</p>
              </div>
              <Switch />
            </div>
            <Separator />
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Use dark theme across the dashboard</p>
              </div>
              <Switch defaultChecked />
            </div>
            <Separator />
