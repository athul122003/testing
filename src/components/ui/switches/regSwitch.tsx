...
const RegisterSwitch = () => {
	...
	return (
		<StyledWrapper className="m-0">
			<div className="text-center mb-2 text-black dark:text-white font-semibold">
				ON
			</div>
			...
			<div className="text-center mt-2 text-black dark:text-white font-semibold">
				OFF
			</div>
		</StyledWrapper>
	);
